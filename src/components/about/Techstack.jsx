  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
      {skills.map((skill, idx) => (
        <div key={idx} className="flex items-center p-6 border border-white/20 rounded-xl bg-white/30 backdrop-blur-xl shadow-lg hover:shadow-xl hover:bg-white/40 transition-all duration-300">
