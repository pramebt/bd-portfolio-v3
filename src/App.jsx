  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-10 h-full w-full bg-white ">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 md:w-[32rem] md:h-[32rem] bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/3 left-1/2 w-56 h-56 md:w-[28rem] md:h-[28rem] bg-teal-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
